...
function DashboardLive.initSpecialization()
	...
	DashboardLive.vanillaSchema:register(XMLValueType.STRING, DashboardLive.DBL_XML_KEY .. "#comp", "Maximum")
	DashboardLive.vanillaSchema:register(XMLValueType.FLOAT, DashboardLive.DBL_XML_KEY .. "#compValue", "Maximum")
	...
	DashboardLive.vanillaSchema:register(XMLValueType.STRING, DashboardLive.DBL_XML_KEY .. "#audioFile", "Path to audio file")
	DashboardLive.vanillaSchema:register(XMLValueType.STRING, DashboardLive.DBL_XML_KEY .. "#audioName", "Unique name of sound sample")
	DashboardLive.vanillaSchema:register(XMLValueType.BOOL, DashboardLive.DBL_XML_KEY .. "#loop", "repeat sound if true")
	DashboardLive.vanillaSchema:register(XMLValueType.FLOAT, DashboardLive.DBL_XML_KEY .. "#volume", "sound volume")
